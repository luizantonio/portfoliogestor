	...
	<div class="row">
        <div class="panel panel-default">
				<div class="panel-heading">
						...
						<div class="col-sm-offset-0 col-sm-0">						    
							<b>Equipe do Projeto</b>:@if(!is_null($projeto)) {{$projeto->nome}}  @endif 
						</div>
				</div>
                ...
                <div class="panel-body">
					@if(!is_null($projeto))	
							...
							@if($projeto->hasMembros($projeto->id ))
									 @php
										$contadorIndicador = 0;
									 @endphp
									@foreach($projeto->getMembrosVetor($projeto->id ) as $membro)
										@php if($contadorIndicador%2===0){ echo '<output style="background-color:lightgray;">';}else{echo '<output style="background-color:lien;">';} $contadorIndicador +=1; @endphp		
											{{ $membro->nome }}{{ $membro->projeto_id }}
